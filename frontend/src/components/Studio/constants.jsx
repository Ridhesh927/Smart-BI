...
export const showMeCharts = [
  ...
  { name: 'Highlight Table', icon: <Table size={18} className="rotate-90" />, type: 'table', req: { dims: '1+', meas: '1+' } },
  ...
  { name: 'Horizontal Bars', icon: <BarChart2 size={18} className="rotate-90" />, type: 'bar', req: { dims: '1+', meas: '1+' } },
  { name: 'Stacked Bars', icon: <BarChart2 size={18} className="rotate-90 opacity-50" />, type: 'bar', req: { dims: '1+', meas: '1+' } },
  { name: 'Side-by-Side Bars', icon: <BarChart2 size={18} className="rotate-90" />, type: 'bar', req: { dims: '1+', meas: '1+' } },
  ...
  { name: 'Dual Lines', icon: <LineChart size={18} />, type: 'line', req: { dims: '1 Date', meas: '2' } },
