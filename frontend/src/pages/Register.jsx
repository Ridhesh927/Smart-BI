...
import { BarChart3, Mail, Lock, User as UserIcon, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center relative overflow-hidden font-sans">
      ...
      <div className="glass p-10 rounded-2xl w-full max-w-md shadow-2xl relative z-10 border border-slate-800">
        ...
        <p className="text-slate-400 mb-8">Start your unlimited free trial today</p>
        ...
        <button 
          ...
          className="w-full bg-white hover:bg-slate-100 text-slate-900 rounded-xl py-3 font-semibold transition-all flex justify-center items-center gap-3"
        >
